...
public class Recordmid {
    private Integer recordmidunid;
    ...
    public Integer getRecordmidunid() {
        return recordmidunid;
    }

    public void setRecordmidunid(Integer recordmidunid) {
        this.recordmidunid = recordmidunid;
    }
    ...
    public void setPiby(String piby) {
        this.piby = piby == null ? null : piby.trim();
    }
    ...
    public void setEnterby(String enterby) {
        this.enterby = enterby == null ? null : enterby.trim();
    }
