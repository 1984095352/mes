  ...
  <body >
   <div class="divcss">
	...
	<form class="form-signin"  method = "post" action="${pageContext.request.contextPath }/user/register.action" onsubmit="return checkpasswd()">
		...
		<input type="text" id="inputLOGINID" name="LOGINID" class="form-control" placeholder="工号" required autofocus> <span id="s"></span>
                             
		<label for="inputDISPLAYNAME" class="sr-only">DISPLAYNAME</label>
		<input type="text" id="inputDISPLAYNAME" name="DISPLAYNAME" class="form-control" placeholder="姓名" required autofocus> 
		...
		<input type="password" id="confirmPASSWORD" name="PASSWORD" class="form-control" placeholder="确认密码" required autofocus>
                
                <label for="inputPROFESSION" class="sr-only">PROFESSION</label>
		<input type="text" id="inputPROFESSION" name="PROFESSION" class="form-control" placeholder="专业" required autofocus>	
                
                <label for="inputDEPARTMENT" class="sr-only">DEPARTMENT</label>
		<input type="text" id="inputDEPARTMENT" name="DEPARTMENT" class="form-control" placeholder="部门" required autofocus>
